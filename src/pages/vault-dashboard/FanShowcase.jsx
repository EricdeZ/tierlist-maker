...
import { Download, X, ChevronDown, ImageIcon } from 'lucide-react'
...
export default function FanShowcase({ entries, collection }) {
    ...
    const [selected, setSelected] = useState([]) // [{ entry, rarity, id }]
    ...
    return (
        <div className="mb-8 bg-white/[0.02] border border-white/10 rounded-xl p-4">
            ...
            {selected.length > 0 && (
                <div className="mb-4">
                    <div className="text-[10px] text-white/40 uppercase tracking-wider mb-2">Selected — reorder with arrows</div>
            ...
            {selected.length > 0 && (
                <div className="mb-4">
                    ...
                    <div
                        ...
                        style={{ background: 'repeating-conic-gradient(#1a1a2e 0% 25%, #12121f 0% 50%) 0 0 / 20px 20px' }}
                    >
                        <div
                            data-fan-bg="true"
                            ...
                            style={{ background: 'repeating-conic-gradient(#1a1a2e 0% 25%, #12121f 0% 50%) 0 0 / 20px 20px' }}
                        />
                        <FanPreview ref={fanRef} selected={selected} settings={settings} />
                    </div>
                </div>
            )}
...
function SelectedCard({ sel, idx, onRemove, onRarityChange, onMoveLeft, onMoveRight }) {
