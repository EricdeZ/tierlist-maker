    ...
    return (
        <div className="forge-hero relative mb-4 bg-[var(--forge-panel)] border border-[var(--forge-edge)] overflow-hidden min-h-44 flex">
            ...
            <div
                ...
                style={{
                    background: 'linear-gradient(135deg, transparent 0%, rgba(232,101,32,0.03) 40%, rgba(255,61,0,0.06) 100%)',
            ...
            <div
                className="absolute top-0 right-0 w-[280px] h-full pointer-events-none opacity-15 hover:opacity-22 transition-opacity"
                style={{
            ...
            <div className="forge-hero-content flex-1 p-4 sm:p-7 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-7 relative z-[1]">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-sm sm:text-[1rem] text-[var(--forge-text-mid)] mb-2 sm:mb-3.5">
                        {player.isFreeAgent ? (
                            <span className="forge-head text-[0.8rem] sm:text-[0.9rem] font-semibold tracking-wider text-[var(--forge-text-dim)] opacity-70">Free Agent</span>
                        ) : (
                            <>
            ...
            <div className="absolute bottom-0 right-0 w-[45%] h-[70px] opacity-40 pointer-events-none">
                <canvas ref={chartRef} />
            </div>
        </div>
    )
