...
const PACK_FEATURED_GODS = {
  ...
  'staff-jumbo': ['Discordia', 'Bellona', 'Athena', 'Hecate', 'Sol'],
}
...
export default function PackArt({
  ...
  const CSS_TIERS = new Set(['standard', 'premium', 'elite', 'legendary', 'mixed', 'osl-mixed', 'bsl-mixed', 'gift', 'promo-gift', 'staff-mixed', 'staff-jumbo'])
  const colorStyle = {}
