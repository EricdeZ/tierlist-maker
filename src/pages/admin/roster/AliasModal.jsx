...
export function AliasModal({ playerName, aliases, onClose, onAddAlias, onRemoveAlias, opLoading }) {
    ...
    return (
        <BaseModal onClose={onClose} maxWidth="max-w-sm" className="overflow-hidden">
            <ModalHeader title={`Aliases for ${playerName}`} subtitle="Old names that should resolve to this player" onClose={onClose} />
