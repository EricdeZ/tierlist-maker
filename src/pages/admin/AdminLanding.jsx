...
const tools = [
    {
        title: 'Tournaments',
        description: 'Create and manage standalone tournaments. Set dates, edit marketing copy, toggle signups, and review/approve player registrations.',
        ...
        btnClass: 'bg-fuchsia-600 hover:bg-fuchsia-700',
    },
    {
        title: 'Match Report',
    ...
    {
        title: 'Stage Manager',
        description: 'Set up tournament structure: stages (regular season, playoffs, finals), conferences/groups, rounds, and bracket visualization with auto-advancement.',
        path: '/admin/stages',
        permission: 'match_schedule',
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        title: 'My Settings',
        description: 'Manage your notification preferences. Control which Discord DM alerts you receive for match reports and data issues.',
        path: '/admin/settings',
        permission: null,
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
        ...
        description: 'Monitor and manage all community (BYOT) teams. Edit names, tiers, and colors. View members and pending invitations. Delete inactive or problematic teams.',
        path: '/admin/community-teams',
        permission: 'league_manage',
        globalOnly: true,
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        title: 'Scrim Monitor',
        description: 'View all scrim activity, track open/accepted/completed counts, resolve disputed outcomes, and cancel problematic scrims. See no-show rates and weekly trends.',
        path: '/admin/scrim-admin',
        permission: 'league_manage',
        globalOnly: true,
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="max-w-4xl mx-auto pb-8 px-4">
            ...
            {isOwner && (
                <div className="mt-12 border-t border-white/10 pt-8 space-y-3">
                    ...
                    <Link
                        to="/admin/card-preview"
                        className="flex items-center gap-3 px-5 py-4 rounded-xl bg-(--color-secondary) border border-amber-500/20 hover:border-amber-500/40 transition-colors"
                    >
                        <svg className="w-5 h-5 text-amber-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                        </svg>
                        <div className="flex-1">
                            <div className="text-sm font-bold text-amber-400">Card Preview</div>
                            <div className="text-xs text-(--color-text-secondary)">
                                Preview trading card designs across all roles and holo effects
                            </div>
                        </div>
                        <svg className="w-4 h-4 text-(--color-text-secondary)/40 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
