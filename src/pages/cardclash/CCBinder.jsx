...
export default function CCBinder() {
  const { collection, binder, binderCards, saveBinder, binderSlotCard, binderUnslotCard, binderGenerateShare } = useCardClash()
  ...
  const handleShare = useCallback(async () => {
    ...
    const url = `${window.location.origin}/cardclash/binder/${token}`
