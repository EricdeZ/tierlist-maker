...
void main() {
  ...
  vec3 col = vec3(0.0);
  float bright1 = 0.5 + 0.5 * cos(TAU * (uv.x + uTime * uSpeed * 0.2 * uColorSpeed + 0.3));
  col += 0.99 * auroraGlow(t, shift) * bright1 * uColor1;
  float bright2 = 0.5 + 0.5 * cos(TAU * (uv.x + uTime * uSpeed * 0.1 * uColorSpeed + 0.5));
  col += 0.99 * auroraGlow(t + uLayerOffset, shift) * bright2 * uColor2;
...
export default function SoftAurora({
    ...
    useEffect(() => {
        ...
        // Hide canvas on page unload to prevent white flash
