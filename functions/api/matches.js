        ...
        if (event.httpMethod === 'GET' && action === 'my-upcoming') {
            ...
            const matches = await sql`
                SELECT
                    ...
                    sm.best_of,
                    sm.week,
                    t1.id as team1_id, t1.name as team1_name, t1.logo_url as team1_logo, t1.color as team1_color, t1.slug as team1_slug,
                    t2.id as team2_id, t2.name as team2_name, t2.logo_url as team2_logo, t2.color as team2_color, t2.slug as team2_slug,
