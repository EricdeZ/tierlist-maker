...
const PERMISSION_KEYS = [
    ...
    { key: 'league_manage',     label: 'League Manage',     description: 'Create/edit leagues, divisions, and seasons', scopeable: true },
    { key: 'team_manage',       label: 'Team Manage',       description: 'Create, edit, delete teams and upload team icons', scopeable: true },
